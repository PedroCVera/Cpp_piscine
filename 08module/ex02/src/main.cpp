...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/25 12:12:34 by pcoimbra          #+#    #+#             */
/*   Updated: 2023/09/25 12:15:31 by pcoimbra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main ()
{
	...
	while (itBegin != itEnd)
	{
		std::cout << "Stack Value for newStack in " << i << " position: " << *itBegin << std::endl;
		itBegin++;
		i++;
	}
	std::cout << std::endl;
	...
	{
		std::cout << "Stack Value for wtfStack in " << i << " position: " << *itBegin2 << std::endl;
		itBegin2++;
		i++;
	}
}